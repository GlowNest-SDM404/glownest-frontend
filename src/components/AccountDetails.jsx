...
export default function AccountDetails({
  ...
  const { user, refreshUserFromToken } = useUser();
  ...
  const initial = {
    ...
    password: "",
    confirmPassword: "",
    newsletter: base.newsletter || false,
  };
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      formData.append("password", form.password || undefined); ;
      formData.append("newsletter", form.newsletter);
